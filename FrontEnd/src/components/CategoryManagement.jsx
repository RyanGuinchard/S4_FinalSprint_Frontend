...
const CategoryManagement = ({ game, setGames }) => {
  ...
  const saveOption = () => {
    ...
    fetch(
      `http://localhost:8080/categories/${selectedCategory.id}/options/${editingOption.id}`,
      {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const deleteOption = (optionId) => {
    ...
    fetch(
      `http://localhost:8080/categories/${selectedCategory.id}/options/${optionId}`,
      {
        method: "DELETE",
      }
    )
  ...
  const addOption = () => {
    ...
    fetch(`http://localhost:8080/categories/${selectedCategory.id}/options`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
